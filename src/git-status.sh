...
WB_STATUS="#[fg=${THEME[base05]},bg=${THEME[base00]},bold]░ $PROVIDER_ICON \
$BRANCH_STATUS$ADD_STATUS$CHANGE_STATUS$DELETE_STATUS$UNTRACKED_STATUS \
$COMMIT_STATUS$FORK_STATUS$STAR_STATUS$ISSUE_STATUS$PR_STATUS$REVIEW_STATUS$RESET"
